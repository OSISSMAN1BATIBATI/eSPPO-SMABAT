...
<html lang="id">
<head>
    <title>Surat Suara Elektronik eSPPO &ndash; Lembar Surat Suara</title>
...
<body>
    <header class="text-white">
        ...
        <h1>Surat Suara Elektronik eSPPO</h1>
    ...
    <div class="container my-4">
        ...
        <form action="submit_vote.php" method="POST">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            <div class="card-header text-center">
                                <input type="radio" name="pilihan" value="<?php echo $k['no_urut_kandidat']; ?>" required>
                            </div>
            ...
            <div class="text-center mt-4">
                <button type="submit" class="btn btn-success">Kirim Pilihan</button>
            </div>
        </form>
    </div>
